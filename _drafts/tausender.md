...
{% include image.html path="media/tausender/abfahrt.jpg" alt="Eli rollt runter Richtung Meer" link="https://photos.app.goo.gl/MpCFu2RpVopPKRko6" %}
...
{% include image.html path="media/tausender/bucht.jpg" alt="Kathi steht über einer türkisblauen Bucht" link="https://photos.app.goo.gl/VJXYzZLpbycC7XMy7" %}
...
{% include image.html path="media/tausender/kuh.jpg" alt="Gefahrenschild Viehtrieb vor einer Berglandschaft mit Gewächshäusern" link="https://photos.app.goo.gl/FbGyBDqav2sjunuz9" %}
...
{% include image.html path="media/tausender/coto.jpg" alt="Ausblick über Hügel mit Gewächshäusern" link="https://photos.app.goo.gl/BgEv5ghzDFk4fP7E9" %}
...
{% include image.html path="media/tausender/andalucia.jpg" alt="Kathi radlt die Küste entlang" link="https://photos.app.goo.gl/egaVox9jLiDLh7DZ7" %}
...
{% include image.html path="media/tausender/patschen.jpg" alt="Eli zeigt einen Schlauch mit vielen Flicken dran" caption="1, 2, 3, 4, 5, ... 6 Flicken!" link="https://photos.app.goo.gl/XnMt2bcnmfbTpCse6" %}
...
{% include image.html path="media/tausender/abfahrt2.jpg" alt="Blick vom Pass vor Carboneras" caption="Am liebsten 10 Mal runterrollen" link="https://photos.app.goo.gl/nVF4HSTMiQ8i7Zb88" %}
...
{% include image.html path="media/tausender/miso.jpg" alt="Eli kocht Miso-Suppe am Balkon" caption="Nie war die Miso-Suppe so gut" link="https://photos.app.goo.gl/nVF4HSTMiQ8i7Zb88" %}
...
{% include image.html path="media/tausender/valle.jpg" alt="Valle de Rodalquilar" link="https://photos.app.goo.gl/Yey1rv3j1y6DpXtj6" %}
...
{% include image.html path="media/tausender/cabo.jpg" alt="Eli snackt am Collado de Vela Blanca" caption="Snacks vor der Abfahrt vom Collado de Vela Blanca" %}
...
{% include image.html path="media/tausender/topf.jpg" alt="Eli füllt einen Kochtopf mit Meerwasser" caption="Wie soll ich mir da einen Topf füllen?" %}
...
{% include video.html path="media/tausender/nachtfahrt.mp4" %}
...
{% include image.html path="media/tausender/kathedrale.jpg" alt="Kathedrale von Almería" link="https://photos.app.goo.gl/KXe4MoXiqwaga2Yr8" %}
...
{% include image.html path="media/tausender/alcazaba.jpg" alt="Eli blickt von den Zinnen der Alcazaba von Almería" %}

{% include image.html path="media/tausender/teashop.jpg" alt="Kathi isst marokkanisches Essen in Almería" caption="Das beste Essen bisher in einem kleinen marokkanischen Restaurant nahe der Alcazaba" link="https://photos.app.goo.gl/vx1tsi9A74KKNySn6" %}
...
{% include video.html path="media/tausender/fussball.mp4" %}
...
{% include image.html path="media/tausender/gitarre.jpg" alt="Eli liest einen Infotext im Gitarrenmuseum von Almería" %}
